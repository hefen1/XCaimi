/*******************************************************
  源程序名称:TradeStockSBSellCDlg.cpp
  软件著作权:恒生电子股份有限公司
  系统名称:  投资赢家金融理财终端V1.0
  模块名称:  交易
  功能说明:  三板确定卖出
...
IMPLEMENT_DYNAMIC(CTradeStockSBSellCDlg, CTradeStockSellDlg)

CTradeStockSBSellCDlg::CTradeStockSBSellCDlg(CWnd* pParent /* = NULL */)
	: CTradeStockSellDlg(pParent)
{

}

CTradeStockSBSellCDlg::~CTradeStockSBSellCDlg()
{

}


BEGIN_MESSAGE_MAP(CTradeStockSBSellCDlg, CTradeStockSellDlg)
	//
	//ON_BN_CLICKED(IDC_BT_OK, &CTradeStockBuy::OnBnClickedBtOk)
END_MESSAGE_MAP()

BOOL CTradeStockSBSellCDlg::OnInit()
{
	if (__super::OnInit())
	{
		m_sEntrustProp = "c";
...
void CTradeStockSBSellCDlg::LoadWnd()
{	

...
/////////////////////////////////////////////////////////////////////
bool CHSDib::IsWin30Dib(){
	return ((*(LPDWORD)(hDib))==sizeof(BITMAPINFOHEADER));
}
/////////////////////////////////////////////////////////////////////
WORD CHSDib::GetPaletteSize()
{
	//    if (IsWin30Dib())
...
/////////////////////////////////////////////////////////////////////
HDIB  CHSDib::Create(DWORD dwWidth, DWORD dwHeight, WORD wBitCount)
{
...
/////////////////////////////////////////////////////////////////////
long CHSDib::Stretch(HDC pDC, long xoffset, long yoffset, long xsize, long ysize)
{
	if((hDib)&&(pDC)) {
		//palette must be correctly filled
		LPSTR lpDIB = (char*)hDib;	//set image to hdc...
...
/////////////////////////////////////////////////////////////////////
void CHSDib::SetPaletteIndex(BYTE idx, BYTE r, BYTE g, BYTE b)
{
	if ((hDib)&&(m_nColors)){
...
/////////////////////////////////////////////////////////////////////
void CHSDib::SetPaletteIndex(BYTE idx, RGBQUAD c)
{
	if ((hDib)&&(m_nColors)){
		BYTE* iDst = (BYTE*)(hDib) + sizeof(BITMAPINFOHEADER);
		if ((idx>=0)&&(idx<m_nColors)){	
...
/////////////////////////////////////////////////////////////////////
void CHSDib::SetPaletteIndex(BYTE idx, COLORREF cr)
{
	if ((hDib)&&(m_nColors)){
		BYTE* iDst = (BYTE*)(hDib) + sizeof(BITMAPINFOHEADER);
		if ((idx>=0)&&(idx<m_nColors)){	
...
/////////////////////////////////////////////////////////////////////
RGBQUAD CHSDib::GetPaletteIndex(BYTE idx)
{
	RGBQUAD rgb = {0,0,0,0};
	if ((hDib)&&(m_nColors)){
		BYTE* iDst = (BYTE*)(hDib) + sizeof(BITMAPINFOHEADER);
...
/////////////////////////////////////////////////////////////////////
BYTE CHSDib::GetPixelIndex(long x,long y)
{
...
/////////////////////////////////////////////////////////////////////
RGBQUAD CHSDib::GetPixelColor(long x,long y)
{
	RGBQUAD rgb={0,0,0,0};
...
/////////////////////////////////////////////////////////////////////
void CHSDib::SetPixelIndex(long x,long y,BYTE i)
{
	if ((hDib==NULL)||(m_nColors==0)||
...
/////////////////////////////////////////////////////////////////////
void CHSDib::SetPixelColor(long x,long y,COLORREF cr)
{
	SetPixelColor(x,y,RGB2RGBQUAD(cr));
	return;
}
/////////////////////////////////////////////////////////////////////
void CHSDib::SetPixelColor(long x,long y,RGBQUAD c)
{
	if ((hDib==NULL)||(x<0)||(y<0)||
...
/////////////////////////////////////////////////////////////////////
BYTE CHSDib::GetNearestIndex(RGBQUAD c)
{
...
/////////////////////////////////////////////////////////////////////
RGBQUAD CHSDib::RGBtoHSL(RGBQUAD lRGBColor)
{
...
/////////////////////////////////////////////////////////////////////
WORD CHSDib::HueToRGB(WORD n1,WORD n2,WORD hue)
{ 
...
/////////////////////////////////////////////////////////////////////
RGBQUAD CHSDib::HSLtoRGB(COLORREF cHSLColor)
{
	return HSLtoRGB(RGB2RGBQUAD(cHSLColor));
}
/////////////////////////////////////////////////////////////////////
RGBQUAD CHSDib::HSLtoRGB(RGBQUAD lHSLColor)
{ 
	WORD hue,lum,sat;
...
/////////////////////////////////////////////////////////////////////
RGBQUAD CHSDib::RGB2RGBQUAD(COLORREF cr)
{
	RGBQUAD c;
...
/////////////////////////////////////////////////////////////////////
COLORREF CHSDib::RGBQUAD2RGB (RGBQUAD c)
{
	return RGB(c.rgbRed,c.rgbGreen,c.rgbBlue);
}
/////////////////////////////////////////////////////////////////////
void CHSDib::SetGrayPalette()
{
...
/////////////////////////////////////////////////////////////////////
void CHSDib::BlendPalette(COLORREF cr,long perc)
{
	if ((hDib==NULL)||(m_nColors==0)) return;
	BYTE* iDst = (BYTE*)(hDib) + sizeof(BITMAPINFOHEADER);
	long i,r,g,b;
...
/////////////////////////////////////////////////////////////////////
long CHSDib::WriteBMP(LPSTR bmpFileName)
{                         
...
IMPLEMENT_DYNAMIC(CHSShadeButton, CButton)
/////////////////////////////////////////////////////////////////////////////
// CHSShadeButton
CHSShadeButton::CHSShadeButton()
{
	m_Border = 0;				//draw 3D border
...
/////////////////////////////////////////////////////////////////////////////
BEGIN_MESSAGE_MAP(CHSShadeButton, CButton)
	//{{AFX_MSG_MAP(CHSShadeButton)
	ON_WM_ERASEBKGND()
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	ON_WM_MOUSEMOVE()
...
END_MESSAGE_MAP()
/////////////////////////////////////////////////////////////////////////////
// CHSShadeButton message handlers
/////////////////////////////////////////////////////////////////////////////
BOOL CHSShadeButton::OnEraseBkgnd(CDC* pDC) 
{
	return 1;	// doesn't erase the button background
}

long CHSShadeButton::Draw(HDC pDC, CRect rect,BOOL bTracking /*= FALSE*/)
{
	if( pDC ) 
	{
		if( bTracking == 2 )     // focus
		{
			if( m_button_down )
			{
				//FillRect(pDC, &rect, (HBRUSH) (COLOR_WINDOWFRAME + 1));
			}
			else
			{
				FillRect(pDC, &rect, (HBRUSH) (COLOR_INFOBK + 1));
			...
			FillRect(pDC, &rect, (HBRUSH) hBrush );
			hBrush.DeleteObject();*/
		}
		else if( bTracking == 1) // mouse over
		{
			FillRect(pDC, &rect, (HBRUSH) (COLOR_WINDOW + 1));
		}
		else
...
//
/////////////////////////////////////////////////////////////////////////////
void CHSShadeButton::SetShade(UINT shadeID,BYTE granularity,BYTE highlight,BYTE coloring,COLORREF color)
{
...
/////////////////////////////////////////////////////////////////////////////
COLORREF CHSShadeButton::SetTextColor(COLORREF new_color)
{
...
#if Support_ButtonToolTip
/////////////////////////////////////////////////////////////////////////////
void CHSShadeButton::SetToolTipText(CString s)
{
	m_strTipText = s;
}
#endif
...
#if Support_ButtonToolTip
/////////////////////////////////////////////////////////////////////////////
void CHSShadeButton::RelayEvent(UINT message, WPARAM wParam, LPARAM lParam)
{
...
//
//---------------------------------------------------------
void CHSShadeButton::OnLButtonDown(UINT nFlags, CPoint point)
{
    //TRACE("* %08X: down\n", ::GetTickCount());
	...
	if( nFlags == 0 && 
		...
		this->GetParent() )
	{
		this->GetParent()->SendMessage(WM_COMMAND,(WPARAM)this->GetDlgCtrlID(),0);
	}
...
//
//---------------------------------------------------------
void CHSShadeButton::OnLButtonUp(UINT nFlags, CPoint point)
{
    //TRACE("* %08X: up\n", ::GetTickCount());
#if Support_ButtonToolTip
	//Pass this message to the ToolTip control
...
//
//---------------------------------------------------------
void CHSShadeButton::OnMouseMove(UINT nFlags, CPoint point)
{
    //TRACE("* %08X: Mouse\n", ::GetTickCount());
#if Support_ButtonToolTip
	//Pass this message to the ToolTip control

/*	m_Tip.Show("", m_strTipText);*/
#endif
...
//
//---------------------------------------------------------
LRESULT CHSShadeButton::OnMouseLeave(WPARAM, LPARAM)
{
    ASSERT (m_tracking);
    //TRACE("* Mouse leave\n");
    m_tracking = false;
...
//
//---------------------------------------------------------
void CHSShadeButton::OnKillFocus(CWnd *new_wnd)
{
...
BOOL CHSShadeButton::SubclassWindow(HWND hWnd) 
{
	BOOL bRet = CWnd::SubclassWindow(hWnd);
...
HWND CHSShadeButton::UnsubclassWindow() 
{

// DlgConSelStock.cpp : implementation file --added by HS
//
...
IMPLEMENT_DYNAMIC(CDlgConSelStock, CDialog)
CDlgConSelStock::CDlgConSelStock(CWnd* pParent /*=NULL*/,
								   HSOpenExpressUseData* pData/* = NULL*/,
								   long* pThis /*= NULL*/)
								   : CDialog(CDlgConSelStock::IDD, pParent)
								   , m_bCheckChuQuan(FALSE)
{
	...
	if( pThis )
	{
		CDialog::Create(CDlgConSelStock::IDD,pParent);
		CenterWindow(CWnd::FromHandle(g_hParentWnd));
	}
}

CDlgConSelStock::~CDlgConSelStock()
{
}

void CDlgConSelStock::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDlgConSelStock, CDialog)
	//{{AFX_MSG_MAP(CDlgConSelStock)
	ON_WM_SIZE()
...
BOOL CDlgConSelStock::OnInitDialog() 
{
...
void CDlgConSelStock::Init(int nCopy/* = CTreeCtrlFormula::CopyDelete*/)
{
...
/*void CDlgConSelStock::OnSize(UINT nType, int cx, int cy) 
{
...
*/
void CDlgConSelStock::OnAdvance() 
{
...
void CDlgConSelStock::OnUsernotes() 
{
...
void CDlgConSelStock::OnOK() 
{
	m_strBlock.Empty();
	Select();
}

int CDlgConSelStock::Select() 
{
...
int CDlgConSelStock::DoSelectStock( SelStockCondition* pSelStockCondition ,int style)
{
...
void CDlgConSelStock::OnToblock() 
{
	// TODO: Add your control notification handler code here
	//need to modify 打开板块 自选板块
	//::SendMessage(g_hParentWnd,HX_USER_COMPILEDATA,1,(LPARAM)this);
}

long CDlgConSelStock::LoadCurExp(WPARAM wParam /*= 0*/, LPARAM lParam /*= 0*/)
{	
...
BOOL CDlgConSelStock::ShowWindow( int nCmdShow )
{
...
CString CDlgConSelStock::GetNameByKey(CString& strFindKeyName) 
{
	CString strRet;
	if( g_pTableHeadData )
	{
...
BOOL CDlgConSelStock::SaveLoad(UINT nMode,CString strFileName /*= ""*/,DWORD dStyle /*= 0*/)
{
	/*if( !IsType(Condition) )
	return 0;
	*/
...
void CDlgConSelStock::Serialize(CArchive& ar,int& nCountRef)
{
	nCountRef = 0;
...
void CDlgConSelStock::OnButexpress() 
{
	// TODO: Add your control notification handler code here
	CTreeCtrlFormula* pCurTree = m_wndTab.GetTree();
	if( pCurTree )
...
void CDlgConSelStock::OnButparam() 
{
	// TODO: Add your control notification handler code here
	CDlgFormulaMan* pParentDlg  = (CDlgFormulaMan*)this->GetParent();
	if( pParentDlg == NULL )
...
void CDlgConSelStock::MyNcDestroy()
{
/*	::SendMessage(g_hParentWnd,HX_USER_COMPILEDATA,20,0);*/
}

void CDlgConSelStock::Delete()
{
...
void CDlgConSelStock::OnBnClickedClose()
{
	// TODO: Add your control notification handler code here
}
...
LRESULT CDlgConSelStock::OnExchangeData(WPARAM wp,LPARAM lp)
{
	if( wp == 1 ) // 股票列表
	{		
	}
	...
	else if( wp == 4 ) // 选股结束
	{
		...
		{
			MessageBox("很遗憾，没找到您想要的股票！","提示",MB_ICONINFORMATION);
		}*/
		//this->m_bSelStockState = false;
		//		EnableBut(TRUE);
	}
...
//void CDlgConSelStock::OnBnClickedOk()
//{
//	// TODO: Add your control notification handler code here
//	OnOK();
//}

void CDlgConSelStock::OnBnClickedButfind()
{
	// TODO: Add your control notification handler code here
	DWORD dwMask = 0;
	dwMask = Condition;
...
LRESULT CDlgConSelStock::OnUserDragData(WPARAM wParam, LPARAM lParam)
{
...
INT_PTR CDlgConSelStock::DoModal()
{
...
void CDlgConSelStock::OnSelchangeTab(NMHDR* pNMHDR, LRESULT* pResult) 
{

...
#define Support_ButtonToolTip 1

/////////////////////////////////////////////////////////////////////////////
// CHSShadeButton window
...
public:
	...
	long Draw(HDC pDC, long xoffset, long yoffset,BOOL bTracking = FALSE);
...
class CHSShadeButton : public CButton
{
	DECLARE_DYNAMIC(CHSShadeButton)
...
protected:
	...
	CHSDib m_dNormal,m_dDown,m_dDisabled,m_dOver,m_dh,m_dv;

	//{{AFX_MSG(CHSShadeButton)
	...
	virtual	long   Draw(HDC pDC, CRect rect,BOOL bTracking = FALSE);

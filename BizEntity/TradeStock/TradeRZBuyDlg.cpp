...
IMPLEMENT_DYNAMIC(CTradeRZBuyDlg, CTradeStockBuyDlg)

CTradeRZBuyDlg::CTradeRZBuyDlg(CWnd* pParent /* = NULL */)
...
CTradeRZBuyDlg::~CTradeRZBuyDlg()
{

}

void CTradeRZBuyDlg::DoDataExchange(CDataExchange* pDX)
{
	__super::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CTradeRZBuyDlg, CTradeStockBuyDlg)
	//
	//ON_BN_CLICKED(IDC_BT_OK, &CTradeStockBuy::OnBnClickedBtOk)
END_MESSAGE_MAP()

void CTradeRZBuyDlg::LoadWnd()
{

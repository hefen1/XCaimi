...
{
	//RegisterHotKey(HK_NOOPERATNOTIFY,0,10);
...
void CWinnerStatusBar::OnNoOperatTimeout()
{
	MessageBox("aaaa","aaaa",MB_OK);
	OutputDebugString("[CWinnerStatusBar::OnNoOperatTimeout] time out \n");
}

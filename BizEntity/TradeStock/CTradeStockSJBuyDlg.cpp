...
IMPLEMENT_DYNAMIC(CTradeStockSJBuyDlg, CTradeStockBuyDlg)

CTradeStockSJBuyDlg::CTradeStockSJBuyDlg(CWnd* pParent /* = NULL */)
	: CTradeStockBuyDlg(pParent)
{

}

CTradeStockSJBuyDlg::~CTradeStockSJBuyDlg()
{

}

void CTradeStockSJBuyDlg::DoDataExchange(CDataExchange* pDX)
{
	__super::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CTradeStockSJBuyDlg, CTradeStockBuyDlg)
	//
	//ON_BN_CLICKED(IDC_BT_OK, &CTradeStockBuy::OnBnClickedBtOk)
END_MESSAGE_MAP()

void CTradeStockSJBuyDlg::LoadWnd()
{

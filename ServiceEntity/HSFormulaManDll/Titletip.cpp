...
void CTitleTip::OnLButtonDblClk(UINT nFlags, CPoint point) 
{
	...
	Hide();
	pWnd->PostMessage(WM_LBUTTONDBLCLK,hittest,MAKELONG(point.x,point.y));
...
void CTitleTip::OnLButtonDown(UINT nFlags, CPoint point) 
{
	...
	Hide();
	pWnd->PostMessage(WM_LBUTTONDOWN,hittest,MAKELONG(point.x,point.y));
}
...
void CTitleTip::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
	// TODO: Add your message handler code here and/or call default
	Hide();
	m_pParentWnd->SendMessage( WM_KEYDOWN, nChar, MAKELONG(nRepCnt,nFlags) );
...
void CTitleTip::OnRButtonDown(UINT nFlags, CPoint point) 
{
	...
	Hide();
	pWnd->PostMessage(WM_RBUTTONDOWN,hittest,MAKELONG(point.x,point.y));

//	m_pParentWnd->SendMessage( WM_RBUTTONDOWN, nFlags, MAKELONG(point.x,point.y) );
//	CWnd::OnRButtonDown(nFlags, point);
//	Hide();
}

void CTitleTip::OnRButtonDblClk(UINT nFlags, CPoint point) 
{
	// TODO: Add your message handler code here and/or call default
...
void CTitleTip::OnSysKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
	// TODO: Add your message handler code here and/or call default
	Hide();
	m_pParentWnd->SendMessage( WM_SYSKEYDOWN, nChar, MAKELONG(nRepCnt,nFlags) );
